...
export const EXERCISES: ExerciseDefinition[] = [
  { id: 'ex1', name: 'Sentadilla en cajón', category: 'Miembro Inferior • Rodilla • Fuerza / Potencia', bodyRegion: 'Miembro Inferior', subRegion: 'Rodilla', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1574680178050-55c6a6a96e0a?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 1 },
  { id: 'ex2', name: 'Puente de glúteos unipodal', category: 'Miembro Inferior • Cadera • Fuerza / Potencia', bodyRegion: 'Miembro Inferior', subRegion: 'Cadera', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 2 },
  { id: 'ex3', name: 'Press Paloff', category: 'Zona Media / Columna • Abdomen / Core • Propiocepción / Equilibrio', bodyRegion: 'Zona Media / Columna', subRegion: 'Abdomen / Core', movementType: 'Propiocepción / Equilibrio', videoUrl: 'https://images.unsplash.com/photo-1534258936925-c58bed479fcb?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 2 },
  { id: 'ex4', name: 'Estocadas con mancuerna', category: 'Miembro Inferior • Muslo / Isquios / Cuádriceps • Fuerza / Potencia', bodyRegion: 'Miembro Inferior', subRegion: 'Muslo / Isquios / Cuádriceps', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1597452485669-2c7bb5fef90d?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 3 },
  { id: 'ex5', name: 'Movilidad y flexión de tobillo', category: 'Miembro Inferior • Tobillo y Pie • Movilidad / Rango Articular', bodyRegion: 'Miembro Inferior', subRegion: 'Tobillo y Pie', movementType: 'Movilidad / Rango Articular', videoUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=200&h=200&fit=crop', metricType: 'time', difficulty: 1 },
  { id: 'ex6', name: 'Remo TRX', category: 'Miembro Superior • Hombro y Escápula • Fuerza / Potencia', bodyRegion: 'Miembro Superior', subRegion: 'Hombro y Escápula', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1598971639058-fab3c3109a05?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 2 },
  { id: 'ex7', name: 'Plancha Frontal', category: 'Zona Media / Columna • Abdomen / Core • Fuerza / Potencia', bodyRegion: 'Zona Media / Columna', subRegion: 'Abdomen / Core', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=200&h=200&fit=crop', metricType: 'time', difficulty: 2 },
  { id: 'ex8', name: 'Bicho Muerto (Deadbug)', category: 'Zona Media / Columna • Abdomen / Core • Propiocepción / Equilibrio', bodyRegion: 'Zona Media / Columna', subRegion: 'Abdomen / Core', movementType: 'Propiocepción / Equilibrio', videoUrl: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 1 },
  { id: 'ex9', name: 'Monster Walk', category: 'Miembro Inferior • Cadera • Fuerza / Potencia', bodyRegion: 'Miembro Inferior', subRegion: 'Cadera', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1542766788-a2f588f447ee?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 1 },
  { id: 'ex10', name: 'Vuelos Laterales', category: 'Miembro Superior • Hombro y Escápula • Fuerza / Potencia', bodyRegion: 'Miembro Superior', subRegion: 'Hombro y Escápula', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 2 },
  { id: 'ex11', name: 'Rotación externa con banda', category: 'Miembro Superior • Hombro y Escápula • Fuerza / Potencia', bodyRegion: 'Miembro Superior', subRegion: 'Hombro y Escápula', movementType: 'Fuerza / Potencia', videoUrl: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=200&h=200&fit=crop', metricType: 'tension', difficulty: 1 },
  { id: 'ex12', name: 'Neurodinamia del Nervio Ciático (Slump Test Slider)', category: 'Miembro Inferior • Cadera • Neurodinamia / Movilización Neural', bodyRegion: 'Miembro Inferior', subRegion: 'Cadera', movementType: 'Neurodinamia / Movilización Neural', videoUrl: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=200&h=200&fit=crop', metricType: 'time', difficulty: 2 },
  { id: 'ex13', name: 'Dorsiflexión de Tobillo con Carga', category: 'Miembro Inferior • Tobillo y Pie • Movilidad / Rango Articular', bodyRegion: 'Miembro Inferior', subRegion: 'Tobillo y Pie', movementType: 'Movilidad / Rango Articular', videoUrl: 'https://images.unsplash.com/photo-1574680178050-55c6a6a96e0a?w=200&h=200&fit=crop', metricType: 'kg', difficulty: 2 },
  { id: 'ex14', name: 'Retracción Cervical (Chin Tuck)', category: 'Cabeza y Cuello • Cuello / Cervical • Movilidad / Rango Articular', bodyRegion: 'Cabeza y Cuello', subRegion: 'Cuello / Cervical', movementType: 'Movilidad / Rango Articular', videoUrl: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=200&h=200&fit=crop', metricType: 'time', difficulty: 1 },
];
